...
router.post("/login", async (req, res) => {
    try{
        ...
        const {password, ...others} = user.toSource(); //._doc function added to avoid showing far more information than needed in our attempt to remove the password from the requested information. This method is deprecated.
